...
public class NodeBasedEditor : EditorWindow
{
    ...
    private static void OpenWindow()
    {
        ...
        EditorWindow.FocusWindowIfItsOpen<NodeBasedEditor>();
    }
    ...
    private readonly Rect _zoomArea = new Rect(0.0f, 35.0f, 1600.0f, 1500.0f);
    ...
    private void SaveSkillTree()
    {
        if (nodes.Count > 0)
        {
            ...
            path = "Assets/Scripts/Data/skilltree.json";
    ...
    private void SaveNodes()
    {
        ...
        string path = "Assets/Scripts/Data/nodeData.json";
